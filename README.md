# NEON VOID v4.0 — آرنا سروایور نئونی (فتح خلأ)

بازی Arena Survival کامل با **انجین اختصاصی Canvas 2D**: فیزیک، ۱۱ هوش مصنوعی دشمن با هویت بصری،
الیت‌ها با ۴ affix، موتاتور موج‌ها، ۶ پاورآپ، تیغه‌های مداری، موشک‌های جوینده، انفجار نووا،
سیستم ذرات پول‌شده، موزیک تطبیقی سنتزشده (کمپرسور + داک + درام + شدت)، باس‌های چندمرحله‌ای (tier)،
۲۴ ارتقای روگ‌لایت + ری‌رول + اسکیپ، دوربین lookahead، جم‌های رده‌بندی‌شده،
کمبو، دش گوستی، مینی‌مپ زنده، ۴ کشتی، **آزمایشگاه متا (ارتقای دائمی)**،
**پیروزی در موج ۲۰**، گرید S/A/B/C، لیدربورد محلی و ۱۲ اچیومنت پاداش‌دار.
...
## گیم‌پلی v4.0 (فتح خلأ)

- **هدف:** فتح موج ۲۰ = پیروزی (گرید S، ‎+۲۵۰۰ امتیاز، +۱۰◇) با سینماتیک آتش‌بازی؛ رکورد و لیدربورد ثبت می‌شود.

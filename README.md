# NEON VOID v3.1 — آرنا سروایور نئونی (ریتم توربو)
...
**سرعت بازی (آرام/استاندارد/توربو)**، گرید S/A/B/C، لیدربورد محلی و ۱۲ اچیومنت ماندگار.
...
## گیم‌پلی v3.1 (ریتم توربو)

- **سرعت بازی:** آرام (0.9×) / استاندارد (1×) / توربو (1.۲۵×) — کل شبیه‌سازی تندتر، بالانس نسبی حفظ می‌شود.
- **ریتم تندتر:** اسپاون متراکم‌تر از موج ۵، استراحت بین موج ۲ ثانیه، لول‌آپ سریع‌تر، مگنت قوی‌تر.
